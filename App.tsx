          ...
          <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-lg shadow-md flex-wrap gap-4">
            {activeView.type === 'difficult' ? (
              <div className="w-full flex justify-center items-center gap-4">
                  ...
                  <button onClick={() => setShowMindMap(true)} className="flex items-center gap-2 px-3 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors">
